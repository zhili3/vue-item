  ...
  export default {
    ...
    props: {
      ...
      propNames: {
        type: Object,
        default(){
          return {children: 'children', label: 'label', id: 'id',description:'description',sign:'sign'}
        },
        roleProps(){
          return {children: 'children', label: 'label', id: 'id',description:'description',sign:'sign'}
        },
        accessProps(){
          return {children: 'children', label: 'label', id: 'id',description:'description',sign:'sign',signid:"signid"}
        }
      },
      multipleLimit: {
        type: Number,
